...
import { OnboardingProgressBar } from "@/components/shared/OnboardingChecklist";
...
export function Sidebar() {
  ...
  const adminNav = user?.is_admin ? [{ to: "/admin", label: "Admin", icon: Shield }] : [];
  ...
  return (
    <aside className={cn(
      ...
      {/* Onboarding progress */}
      {sidebarOpen && <OnboardingProgressBar />}
